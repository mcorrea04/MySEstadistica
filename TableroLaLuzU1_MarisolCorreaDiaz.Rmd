---
title: "Tablero Carrera la Luz 2022 - Marisol Correa Diaz"
subtile: "Unidad 1 - Métodos y Simulación Estadística- Marisol Correa Diaz"
output: 
...
```
**Análisis Datos Carrera la Luz 2022** 

Al usar el gráfico de dispersión del tiempo de las categorias se puede concluir que los datos se encuentran relacionados, por ello se pueden distinguir las diferentes categorias. Por otro lado, al comparar las categorias de los hombres y de las mujeres, se puede observar que los rangos son más amplios para para la categoria de las mujeres, sin embargo, se puede ver que en las categorias de los hombres hay más datos atipicos. Entre las categorias abiertas de mujeres y hombre se ve una diferencia en los tiempos en cuanto a la frecuencia ya que la mayoria de los hombres de encuentran en un tiempo menor a 60 minutos, mientras que en las mujeres el tiempo es mayor. 
